...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'event_device', 'device_type',
                      self.gf('django.db.models.fields.CharField')(default='android', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.device_type'
        db.delete_column(u'event_device', 'device_type')
