...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.two_day_reminder_sent'
        db.add_column(u'event_event', 'two_day_reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.two_hour_reminder_sent'
        db.add_column(u'event_event', 'two_hour_reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.two_day_reminder_sent'
        db.delete_column(u'event_event', 'two_day_reminder_sent')

        # Deleting field 'Event.two_hour_reminder_sent'
        db.delete_column(u'event_event', 'two_hour_reminder_sent')
