...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Event.opponent' to match new field type.
        db.rename_column(u'event_event', 'opponent_id', 'opponent')
        # Changing field 'Event.opponent'
        db.alter_column(u'event_event', 'opponent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Removing index on 'Event', fields ['opponent']
        db.delete_index(u'event_event', ['opponent_id'])


    def backwards(self, orm):
        # Adding index on 'Event', fields ['opponent']
        db.create_index(u'event_event', ['opponent_id'])


        # Renaming column for 'Event.opponent' to match new field type.
        db.rename_column(u'event_event', 'opponent', 'opponent_id')
        # Changing field 'Event.opponent'
        db.alter_column(u'event_event', 'opponent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['event.Team']))
