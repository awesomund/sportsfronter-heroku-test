...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.last_signup_datetime'
        db.add_column(u'event_event', 'last_signup_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.last_signup_datetime'
        db.delete_column(u'event_event', 'last_signup_datetime')
