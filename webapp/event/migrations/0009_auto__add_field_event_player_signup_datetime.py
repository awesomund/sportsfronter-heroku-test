...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event_Player.signup_datetime'
        db.add_column(u'event_event_player', 'signup_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event_Player.signup_datetime'
        db.delete_column(u'event_event_player', 'signup_datetime')
