...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'event_event_group', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal(u'event', ['Event_Group'])

        # Adding field 'Event.event_group'
        db.add_column(u'event_event', 'event_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_group', null=True, to=orm['event.Event_Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Event_Group'
        db.delete_table(u'event_event_group')

        # Deleting field 'Event.event_group'
        db.delete_column(u'event_event', 'event_group_id')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'event_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'event_group'", 'null': 'True', 'to': u"orm['event.Event_Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
