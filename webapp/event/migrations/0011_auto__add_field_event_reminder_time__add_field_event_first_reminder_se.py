...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.reminder_time'
        db.add_column(u'event_event', 'reminder_time',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.first_reminder_sent'
        db.add_column(u'event_event', 'first_reminder_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.reminder_time'
        db.delete_column(u'event_event', 'reminder_time')

        # Deleting field 'Event.first_reminder_sent'
        db.delete_column(u'event_event', 'first_reminder_sent')
