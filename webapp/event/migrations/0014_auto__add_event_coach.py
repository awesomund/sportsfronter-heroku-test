...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event_Coach'
        db.create_table(u'event_event_coach', (
        ...
        db.send_create_signal(u'event', ['Event_Coach'])


    def backwards(self, orm):
        # Deleting model 'Event_Coach'
        db.delete_table(u'event_event_coach')
